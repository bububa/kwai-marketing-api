...
type ListRequest struct {
	AdvertiserID   int64   `json:"advertiser_id"`              // 广告主 ID，在获取 access_token 的时候返回
	CampaignID     int64   `json:"campaign_id,omitempty"`      // 广告计划 ID，过滤筛选条件，若不传或传空则视为无限制条件
	UnitID         int64   `json:"unit_id,omitempty"`          // 广告组 ID，过滤筛选条件，若不传或传空则视为无限制条件
	CreativeID     int64   `json:"creative_id,omitempty"`      // 广告创意 ID，过滤筛选条件，若不传或传空则视为无限制条件
	CreativeName   string  `json:"creative_name,omitempty"`    // 广告创意名称，过滤筛选条件，支持模糊搜索和精确查询
	CreativeIDs    []int64 `json:"creative_ids,omitempty"`     // 广告创意 ID 集，不超过 100 个
