...
type ListRequest struct {
	AdvertiserID     int64   `json:"advertiser_id,omitempty"`      // 必填，广告主 ID，在获取 access_token 的时候返回
	CampaignID       int64   `json:"campaign_id,omitempty"`        // 选填，广告计划 ID，过滤筛选条件，若不传或传空则视为无限制条件
	UnitID           int64   `json:"unit_id,omitempty"`            // 选填，广告组 ID，过滤筛选条件，若不传或传空则视为无限制条件
	UnitName         string  `json:"unit_name,omitempty"`          // 选填，广告组名称，过滤筛选条件，支持模糊搜索&精确查询
	UnitIDs          []int64 `json:"unit_ids,omitempty"`           // 选填，广告组 ID 集，不超过 100 个
